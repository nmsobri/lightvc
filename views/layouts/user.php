            ...
            <div id="right_column_container">
                ...
                <div id="profile">
                    ...
                    <div class="module" id="avatar">
                        ...
                        <img src="<?php echo IMG_PATH. USER_DEFAULT_IMAGE ?>" id="profile_image">
                        <?php else: ?>
                    ...
                    <div id="left_column">
                        ...
                        <div class="module">
                            ...
                            <ul>
                                ...
                                <li class=""><a href="<?php echo APP_PATH . $profile[ 0 ][ 'username' ] ?>" class="list-link">Your Profile<i class="chev-right"></i></a></li>
                                <li class=""><a href="<?php echo APP_PATH . 'user/inbox' ?>" class="list-link">Inbox<i class="chev-right"></i></a></li>
                                <li class=""><a href="<?php echo APP_PATH . 'user/outbox' ?>" class="list-link">Outbox<i class="chev-right"></i></a></li>
